...
const data = [
  {
    picture: CLOVERFIELD,
    title: "Cloverfield",
    nftLimited: "NFT limited to 3,000 copies",
    price: "10,000",
    color: "#c1d117",
    percentA: "4",
    percentB: "5",
  ...
  },
  {
    picture: CLOVERYARD,
    title: "Cloveryard",
    nftLimited: "NFT limited to 30,000 copies",
    price: "1,000",
    color: "#00a65a",
    percentA: "2",
    percentB: "2.5",
  ...
  },
  {
    picture: CLOVERPOT,
    title: "Cloverpot",
    nftLimited: "NFT limited to 300,000 copies",
    price: "100",
    color: "#3c6f66",
    percentA: "1",
    percentB: "1.5",
      ...
      <Container maxWidth="md">
        ...
        >
          ...
          >
            ...
            SEED$ that he could regrow and could make him earn more and more. <br />
            <br />
            It didn't take long before other farmers rushed into this one a
            lifetime opportunity, and tap into this new found Eldorado. They
          ...
          >
            ...
            mandatory to come and water your fields every 48 hours at most to keep your
          ...
          >
            ...
            into the wallet of a stakeholder holding a NFT of 15%.
          </Paragraph>
          <Title
            className="gradienttext"
            sx={{
          ...
          >
              ...
              {data.map((item, index) => {
                return (
                  <Grid item xs={12} sm={6} md={4} key={index}>
                    <CardTitle title={item.title} color={item.color} />
                    <Box
                      sx={{
                        fontFamily: `Maven Pro, sans-serif`,
                        fontStyle: `normal`,
            ...
            <br />
            Like on any farm, watering is important. Every 48h at most, you will have to
            water your land.
            <br />
            ...
            <br />
            <br />
            <span className="roadmap-title">4- HARVEST AND FLEX </span>
            <br />
          ...
          >
            <div style={{ display: "flex" }}>
              ...
              <div className="check-content">
                NFT, STAKING, FARMING, LUCKY, BLOCKCHAIN, CLOVER, BINANCE
              </div>
            </div>
          </Paragraph>
          <Title
          ...
          >
            ...
            welcome to contact us on <span style={{ color: "#bfd10a" }}>support@clover-seeds.financial</span>.
          </Paragraph>
          <div>
            <Faq />
          </div>
